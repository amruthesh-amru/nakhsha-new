  ...
  return (
    ...
    <section className="project_section1 height">
        ...
        <div className="text_content1">
            ...
            <div className="right">
                    <p>
                    At Nakhsha, we with a commitment to architectural excellence and innovative design, our skilled team of professionals passionately creates exceptional living spaces, ranging from cozy family abodes to luxurious multi-unit developments, showcasing unwavering dedication to quality and precision.
                    </p>
            </div>
        </div>
