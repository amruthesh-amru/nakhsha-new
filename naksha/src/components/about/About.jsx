...
TO SUPERB QUALITY
   ...
   <p>
   Vinay Shankar, MBA graduate from RV Institute of Management and executive education at IIM-Bangalore, is an innovative Managing Director known for founding "Cheers Mysore" in 2013, predating Swiggy. His journey in Real Estate began with a leading Mysore construction company, reaching CEO status at 24. Co-founding Nakhsha Group in 2015, Vinay positioned it as a leader in quality construction, with NAKHSHA now Mysore's premier private construction contractor. Also, as the Managing Partner at Mysore Union, he oversees Mysore's largest private Sports & Fitness Club, recipient of the "Times Business Award 2020" for excellence.
   </p>
    </div>
    <div className="owner_name1">
   <h1> Vinay Shankar</h1>
    </div>
    <div className="owner_image2">
      <img src={owner_image2} alt="" />
    </div>
    <div className="owner_text2">
   <p>
   Pratibha Nayak, a self-made entrepreneur and civil engineer, stands out as a leading female entrepreneur in Mysuru's real estate sector. As a member of Builders Association of India and NARED-CO, she co-founded Nakhsha Group, overseeing brands like Nakhsha Homes, Nakhsha Collectives and Nakhsha Furnishing Studio.
Pratibha, a partner in various ventures, including Mysore Union and Union Catering, Toni & Guy, is recognized for her commitment to transparency, trust, affordability, and quality. With almost 100 projects completed, she leads a team of 100 professionals, showcasing innovation in construction, hospitality, decor, and events. Her influence extends beyond her core business into diverse ventures, reflecting her dedication to success and professionalism.
   </p>
    </div>
    <div className="owner_name2">
